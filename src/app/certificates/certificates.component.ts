...
<div class="flex flex-col sm:flex-row sm:space-x-48 sm:items-center sm:justify-center items-center justify-center mt-2 sm:mt-24">
  ...
  <div class="flex flex-col items-center justify-center">
  <div class="circle flex flex-col items-center justify-center sm:mt-9 overflow-hidden fade-in">
  <img class="sm:w-36 w-16 mb-12 ml-2 object-cover fade-in" src="assets/certificate.png">
   <mat-icon  class="mat-icon -mt-12 sm:-mt-8 fade-in" (click)="downloadPdf(const2)">get_app</mat-icon>
  </div>
  <p class=" sm:text-xl text-base text-gray-500 sm:ml-8 mt-3 sm:mt-6 font-serif w-56 text-center fade-in">GRAPHIC AND DIGITAL PUBLISHING TECHNICANS</p>
  <p class="w-52 text-m   sm:ml-10 text-gray-400 text-center fade-in mb-4 sm:mb-0">certificate of completion of the java developer course</p>
  </div>
  ...
  <p class="text-gray-500 sm:ml-8 mt-3 sm:mt-6 font-serif fade-in sm:text-xl text-base ">GALLUP CERTIFICATE</p>
  <p class="w-48  text-sm sm:text-m  sm:ml-10 text-gray-400 text-center fade-in">a test showing my best predispositions and soft skills</p>
  </div>
  </div>
